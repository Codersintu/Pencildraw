            ...
            <div className="w-full max-w-6xl mx-auto px-5 py-4 rounded-full bg-linear-to-r from-[#465362] via-[#62240C] to-[#526881]">
             <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-10">
                   ...
                   <a href="#feature" className="text-gray-400 hover:text-gray-200 transition-colors">
                       Feature
                   </a>
                   <a href="#about" className="text-gray-400 hover:text-gray-200 transition-colors">
                       About
                   </a>
               </div>
